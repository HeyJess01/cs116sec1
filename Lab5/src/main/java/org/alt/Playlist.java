...
public class Playlist{
	...
	public boolean add(AudioRecording newAudioRecording){
		// Make sure we can add this recording first (not null and enough space)
		if (newAudioRecording != null && numberOfRecordings < MAX_PLAYLIST_SIZE){
			// ...if we can, add it...
			this.recordingList[numberOfRecordings] = newAudioRecording;
			// ...increment the number of recordings...
			this.numberOfRecordings++;
			// ...and add its duration to total playlist duration
			this.durationInSeconds = this.durationInSeconds + newAudioRecording.getDuration();
			// everything worked - return false
			return true;
		} else {
			// ...if we cannot - return false
	...
	public boolean add(VideoRecording newVideoRecording){
		// Make sure we can add this recording first (not null and enough space)
		if (newVideoRecording != null && numberOfRecordings < MAX_PLAYLIST_SIZE){
			// ...if we can, add it...
			this.recordingList[numberOfRecordings] = newVideoRecording;
			// ...increment the number of recordings...
			this.numberOfRecordings++;
			// ...and add its duration to total playlist duration
			this.durationInSeconds = this.durationInSeconds + newVideoRecording.getDuration();
			// everything worked - return false
			return true;
		} else {
			// ...if we cannot - return false
	...
	public void load(File playlistFile){
		if (playlistFile != null){
			try {
				...
				System.out.println("ERROR: File " + playlistFile + " not found!");
			}
		} else {

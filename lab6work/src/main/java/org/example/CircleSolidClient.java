...
public class CircleSolidClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Approximate number of spheres in this cylinder=" +
                (cylinder1.getVolume()/sphere1.getVolume())+"\n");
        ...
        // then use a loop to output the objects in the array to show runtime
//        polymorphism
        CircleSolid [] solids = new CircleSolid [3];
        solids[0] = circleV1;
        solids[1] = new Cylinder(10, 15);
        solids[2] = new Sphere(20);
        for (CircleSolid solid : solids)
            System.out.println(solid.getClass() + " Radius=" + solid.getRadius()
